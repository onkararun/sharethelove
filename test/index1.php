...
//echo "<br>$SQ<br>";
	while($row=mysql_fetch_array($SR)){
		...
		echo "<div>\r";
		if(trim($row[20])!=''){
			echo "<img class='simg' src='$path$row[20]' />";
		}
		if(trim($row[21])!=''){
			echo "<img class='simg' src='$path$row[21]' />";
		}
		if(trim($row[22])!=''){
			echo "<img class='simg' src='$path$row[22]' />";
		}
		if(trim($row[23])!=''){
			echo "<img class='simg' src='$path$row[23]' />";
		}
		if(trim($row[24])!=''){
			echo "<img class='simg' src='$path$row[24]' />";
		}
		echo "</div>\r";
